...
ConstraintLayout btnC;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String prenomm = getIntent().getStringExtra("first_name");
        prenom.setText(prenomm);
        String nomm = getIntent().getStringExtra("last_name");
        nom.setText(nomm);
...
initList();
        ...
        btnC.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("first_name",prenom.getText().toString());
                intent.putExtra("last_name",nom.getText().toString());
    ...
    private void buttonNavigation() {
        ...
        profileBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(CartActivity.this,ProfileActi.class);
                intent.putExtra("first_name",prenom.getText().toString());
                intent.putExtra("last_name",nom.getText().toString());
                intent.putExtra("email",email.getText().toString());
                startActivity(intent);
