...
bntm.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View view) {
        ...
        //----------
        String prenom = getIntent().getStringExtra("first_name");
        txt.setText(prenom);
        String nom = getIntent().getStringExtra("last_name");
        txt3.setText(nom);
    ...
    private void buttonNavigation() {
        ...
        profileBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(MainActivity.this,ProfileActi.class);
                intent.putExtra("first_name",txt.getText().toString());
                intent.putExtra("last_name",txt3.getText().toString());
    ...
    private void recPopolur() {
        ...
        foodDS.add(new FoodD("Sandwish","sandwish","Toutes les légumes,et Kefta",1.3,5,20,1000));
        foodDS.add(new FoodD("Burger","burgar","Burger avec filet de poulet ananas roquette tomates,cheese  et sauce sur fond blanc",1.3,5,20,1000));
